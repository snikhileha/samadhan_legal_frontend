...
export default function LawyerInfo() {
    ...
    return (
        <>
            ...
            <div className='profile' style={{ maxWidth: "800px", width: " 60%",height:"100%", margin: "50px auto" }}>
                ...
                <div style={{ display: 'flex',margin:"0 0 5px 0",justifyContent: 'flexStart',flexDirection:"column", padding: '10px 32vh' }}>
